...
topics_data = {
            'network': [
                {
                    'title': '네트워크 기본',
                    'slug': '네트워크-기본',
                    'content': '''<h3 id="네트워크의-목적과-구성요소">1.1 네트워크의 목적과 구성요소</h3>
            ...
            클라이언트의 QoS 마킹을 신뢰할지 여부를 결정합니다.</p>''',
                ...
                {
                    'title': 'OSI 7계층과 IP/TCP',
                    'slug': 'osi-7계층과-iptcp',
                    'content': '''<h3 id="모델-비교-osi-7계층과-tcpip-4계층의-깊은-이해">2.1 모델 비교:
            ...
            연결을 제공하며, HTTP/3 표준으로 채택되었습니다.</p>''',
                ...
                },
                {
                    'title': 'IP주소',
                    'slug': 'ip주소',
                    'content': '''<h3 id="ipv4-주소-체계-심층-설명">3.1 IPv4 주소 체계 심층 설명</h3>
            ...
            주요 솔루션입니다.</p>''',
                ...
                },
                {
                    'title': '스위칭',
                    'slug': '스위칭',
                    'content': '''<h3 id="이더넷-프레임-mac-주소-arp-심층-설명">4.1 이더넷 프레임, MAC
            주소, ARP 심층 설명</h3>
            ...
            <p><em>설명:</em> 특정 VLAN에 대한 STP 역할과 비용, 루트 포트를 확인합니다.</p>''',
                ...
                },
                {
                    'title': '라우팅',
                    'slug': '라우팅',
                    'content': '''<h3 id="기본-라우팅-및-경로-제어-심층">5.1 기본 라우팅 및 경로 제어
            심층</h3>
            ...
            <p>위 명령어들은 기본적인 라우팅 프로토콜 설정과 NAT 구성을 단위별로 보여 줍니다. <code>show</code> 명령어를 통해 각 프로토콜의 상태와 경로 학습, NAT 변환 현황을 확인하고 문제를 진단할 수 있습니다.</p>''',
                ...
                },
                {
                    'title': '계층별 프로토콜',
                    'slug': '계층별-프로토콜',
                    'content': '''<h3 id="전송-계층-상세-tcpudp-심층-분석">6.1 전송 계층 상세: TCP/UDP
            심층 분석</h3>
            ...
            합니다.</p>''',
                ...
                },
                {
                    'title': '네트워크 보안',
                    'slug': '네트워크-보안',
                    'content': '''<h3 id="aaa-프레임워크-및-확장">7.1 AAA 프레임워크 및 확장</h3>
            ...
            보안 위험이 있으므로 필요 시만 활성화합니다.</li>
                ...
                },
                {
                    'title': '무선 & 이동통신',
                    'slug': '무선-이동통신',
                    'content': '''<h3 id="wifi-표준과-phymac-세부-사항">8.1 Wi‑Fi 표준과 PHY/MAC 세부
            사항</h3>
            ...
            EAP‑SIM/AKA를 이용해 셀룰러 인증 정보를 활용합니다.</p>''',
                ...
                },
                {
                    'title': '클라우드',
                    'slug': '클라우드',
                    'content': '''<h3 id="퍼블릭-클라우드-네트워크-구조-세부-설명">9.1 퍼블릭 클라우드
            네트워크 구조 세부 설명</h3>
